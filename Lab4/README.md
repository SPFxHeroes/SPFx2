# Lab 4: Using Office UI Fabric React components
...
1. When prompted for a solution name, leave the default, followed by <kbd>Enter</kbd>
1. When prompted what type of client you'd like to build, select **WebPart**
1. When prompted for a Web Part name, enter **Document Card Example**.
...
1. In the toolbox, select your `Document Card Example` web part to add
